...
- We use several pre-trained models, specifically `FastText`, `RoBERTa`, `BERT (CNN for Fine Tuning)` and `BERTweet` and adapt them to our problem of hate-speech classification
